...
import trenballRoutes from "./routes/trenballRoutes.js";
import fastcrashRoutes from "./routes/fastcrashRoutes.js";
...
app.use("/api/trenball", trenballRoutes);
app.use("/api/fast-crash", fastcrashRoutes);
