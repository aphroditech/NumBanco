...
import ThreeNumbersHistoryRow from 'components/Tables/ThreeNumbersHistoryRow';
...
function History() {
    ...
    const sortedHistory = user.threeNumbersHistory?.length > 0
        ? user.threeNumbersHistory.sort((a, b) => {
