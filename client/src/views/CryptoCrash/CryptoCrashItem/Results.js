...
function Result() {
    ...
    const sortedHistory = user.cryptoCrashHistory.filter((item) => item.active) && user.cryptoCrashHistory.filter((item) => item.active).length > 0
        ? user.cryptoCrashHistory.filter((item) => item.active) : [];
                            ...
                            {sortedHistory.map((result, index) => (
                                ...
                                >
                                    {typeof result.win === 'number' 
                                        ...
                                        : parseFloat(result.win || 0).toFixed(2)}
                                </Text>
                            ))}
                        </Flex>
                    </Box>
