...
/**
 * Session bet log (demo). Same layout/pagination as PlinkoBetHistory; Side replaces Rows.
 */
export default function HashDiceBetHistory({ results }) {
                            ...
                            <Table variant="simple" color="#fff" height="100%" width="100%" sx={{ tableLayout: 'fixed' }}>
                                ...
                                <Tbody>
                                    {paginatedResults.map((result, index, arr) => {
                                        ...
                                        const mult = Number(result.multiplier);
                                        return (
