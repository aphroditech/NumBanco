...
/** Diamond rounds from `user.diamondHistory` (same row shape as Climb / Alpha Tree). */
function DiamondBetHistory() {
    const user = useSelector((state) => state.user.userInfo) || {};

    const sortedHistory = useMemo(() => {
        const raw = user.diamondHistory;
...
export default DiamondBetHistory;
