...
/** Tarot rounds from `user.tarotHistory` (same row shape as Diamond / Climb when wired). */
function TarotBetHistory() {
    const user = useSelector((state) => state.user.userInfo) || {};

    const sortedHistory = useMemo(() => {
        const raw = user.tarotHistory;
...
export default TarotBetHistory;
