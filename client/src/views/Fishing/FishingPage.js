...
export default function FishingPage() {
    ...
    const fishingFxAnchorRef = useRef(null);
    ...
    const clearWinBangTimers = useCallback(() => {
        if (winFxTimeoutRef.current != null) {
            window.clearTimeout(winFxTimeoutRef.current);
            winFxTimeoutRef.current = null;
        }
        if (bangFxTimeoutRef.current != null) {
            window.clearTimeout(bangFxTimeoutRef.current);
    ...
    const runWinCelebration = useCallback(
        (earn) => {
            ...
            const anchorRect = fishingFxAnchorRef.current?.getBoundingClientRect?.() ?? null;
            setWinFx({
                visible: true,
                totalEarn: n.toFixed(2),
                anchorRect,
            });
            winFxTimeoutRef.current = window.setTimeout(() => {
                winFxTimeoutRef.current = null;
    ...
    const runBangCelebration = useCallback(() => {
        clearWinBangTimers();
        setWinFx({ visible: false, totalEarn: '0', anchorRect: null });
        setBangFxVisible(true);
        bangFxTimeoutRef.current = window.setTimeout(() => {
            bangFxTimeoutRef.current = null;
            setBangFxVisible(false);
        }, BANG_EFFECT_MS);
    }, [clearWinBangTimers]);
    ...
    const handlefishing = async (e) =>  {
        ...
        if (status !== "continue") {
            const winFromHistory = Number(lastHistoryItem?.win ?? 0);
            const fallbackPayout = Number(bet) * Number(multi);

            if (status === "win") {
                openConfirmAndReset("win", "Win!");
                const payout =
                    Number.isFinite(winFromHistory) && winFromHistory > 0
                        ? winFromHistory
                        : fallbackPayout;
    ...
    const handleCashOut = async () => {
        const payout = Number(bet) * Number(multi);
        setStatus("cashout");
                ...
                >
                    ...
                    >
                        ...
                        <Text mt="2" fontSize="sm" color="rgba(255,255,255,0.75)">
                            Keep control, grow multiplier, and cash out your catch.
                        </Text>
                    </Box>
                        ...
                        <VStack align="stretch" spacing="4">
                            ...
                            >
                                <Text fontSize="sm" color="rgba(255,255,255,0.88)" lineHeight="1.55">
                                    Place a bet and try to land the fish. Each successful step increases your multiplier. Manage
                                    your <b>strength</b> and decide when to <b>pull</b>, <b>stay</b>, or <b>cash out</b>.
                                </Text>
                            </Box>
                            ...
                            >
                                ...
                                <VStack align="stretch" spacing="2">
                                    ...
                                    <HStack spacing="3" align="flex-start">
                                        ...
                                        <Text fontSize="sm" color="rgba(255,255,255,0.82)" lineHeight="1.45">
                                            Use <b>PULL</b> / <b>STAY</b> to progress. Watch your strength and the fish position.
                                        </Text>
                                    </HStack>
                                    <HStack spacing="3" align="flex-start">
                                        <Box
                                    ...
                                    <VStack align="stretch" spacing="2">
                                        ...
                                        >
                                            <Text fontSize="sm" color="rgba(255,255,255,0.86)">
                                                Cash out at the right time to <b>WIN</b>.
                                            </Text>
                                        </Box>
                                        <Box
                                            p="2.5"
                                        ...
                                        >
                                            <Text fontSize="sm" color="rgba(255,255,255,0.86)">
                                                If you lose control before cashing out, it’s a <b>BANG</b>.
                                            </Text>
                                        </Box>
                                    </VStack>
                                </Box>
                                ...
                                >
                                    ...
                                    <VStack align="stretch" spacing="2">
                                        <Text fontSize="sm" color="rgba(255,255,255,0.82)">
                                            Your cash out uses your current multiplier.
                                        </Text>
